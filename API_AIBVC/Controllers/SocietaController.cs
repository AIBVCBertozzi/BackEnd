...
namespace API_AIBVC.Controllers
{
    ...
    public class SocietaController : Controller
    {
        ...
        {
            if (db.AggiungiImpianto(aggiungiImp))
        ...
        //Return Tornei societa Finiti
        [HttpGet("TorneiFiniti/{idsocieta}")]
        [ProducesResponseType(400)]
        [ProducesResponseType(404)]
        [ProducesResponseType(200, Type = typeof(DataTable))]
        [Authorize(Roles = "Admin,Societa")]
        public DataTable GetTorneiFinitiSocieta(int idsocieta)
        {
            return db.GetTorneiFinitiSocieta(idsocieta);
        }

        //Return Tornei societa Finiti
        [HttpGet("TorneiInCorso/{idsocieta}")]
        [ProducesResponseType(400)]
        [ProducesResponseType(404)]
        [ProducesResponseType(200, Type = typeof(DataTable))]
        [Authorize(Roles = "Admin,Societa")]
        public DataTable GetTorneiInCorsoSocieta(int idsocieta)
        {
            return db.GetTorneiInCorsoSocieta(idsocieta);
        }
    }
}
