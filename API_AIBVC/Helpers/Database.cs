...
namespace WebAPIAuthJWT.Helpers
{
    public class Database
    {
        ...
        public Database()//Richiamo il file appsettings
        {
            ...
            builder.PersistSecurityInfo = Convert.ToBoolean(ConfigurationManager.AppSetting["DBSettings:PersistSecurityInfo"]);
        ...
        public DataTable GetTorneiTipo(string Tipo)
        {
            ...
            sql += "SELECT DISTINCT Torneo.IDTorneo,Torneo.Titolo,Societa.NomeSocieta,TipoTorneo.Descrizione AS TipoTorneo,CONCAT(Supervisore.Nome,' ',Supervisore.Cognome) as SupervisoreTorneo,CONCAT(SupervisoreArbitrale.Nome,' ',SupervisoreArbitrale.Cognome) AS SupervisoreArbitrale,CONCAT(DirettoreCompetizione.Nome,' ',DirettoreCompetizione.Cognome) as DirettoreCompetizione,FormulaTorneo.Formula,Impianto.NomeImpianto,Comune.Citta,Torneo.QuotaIscrizione,Torneo.PuntiVittoria,Torneo.Montepremi,Torneo.DataInizio,Torneo.DataFine,Torneo.DataChiusuraIscrizioni,Torneo.Gender,NumMaxTeamMainDraw,NumMaxTeamQualifiche,NumTeamQualificati,NumWildCard,Outdoor,RiunioneTecnica,OraInizio " +
            "FROM((((((((((Torneo LEFT JOIN TipoTorneo On Torneo.IDTipoTorneo = TipoTorneo.IDTipoTorneo)LEFT JOIN DelegatoTecnico Supervisore ON Torneo.IDSupervisore = Supervisore.IDDelegato)LEFT JOIN ArbitraTorneo On ArbitraTorneo.IDDelegato = Torneo.IDSupervisoreArbitrale)LEFT JOIN DelegatoTecnico SupervisoreArbitrale On Torneo.IDSupervisoreArbitrale = SupervisoreArbitrale.IDDelegato)LEFT JOIN DelegatoTecnico DirettoreCompetizione On Torneo.IDDirettoreCompetizione = DirettoreCompetizione.IDDelegato)LEFT JOIN FormulaTorneo ON Torneo.IDFormula = FormulaTorneo.IDFormula)LEFT JOIN ImpiantoTorneo On ImpiantoTorneo.IDTorneo = Torneo.IDTorneo)LEFT JOIN Impianto On Torneo.IDImpianto = Impianto.IDImpianto)LEFT JOIN Comune On Impianto.IDComune = Comune.IDComune)LEFT JOIN Societa On Societa.IDSocieta = Torneo.IDSocieta) " +
            "WHERE TipoTorneo.Descrizione=@tipoTorneo AND Torneo.Autorizzato=1 AND Torneo.DataFine>=GETDATE()";
            comando = new SqlCommand(sql, conn);
        ...
        public DataTable GetTorneiTipoStorico(string Tipo)
        {
            SqlDataAdapter adapter;
            SqlCommand comando;
            string sql;
        ...
        public DataTable GetTorneiFinitiDelegato(int idatleta)
        {
            SqlDataAdapter adapter;
            SqlCommand comando;
            string sql;
            ...
            sql += "SELECT DISTINCT Torneo.IDTorneo,Torneo.Titolo,Societa.NomeSocieta,TipoTorneo.Descrizione AS TipoTorneo,CONCAT(Supervisore.Nome,' ',Supervisore.Cognome) as SupervisoreTorneo,CONCAT(SupervisoreArbitrale.Nome,' ',SupervisoreArbitrale.Cognome) AS SupervisoreArbitrale,CONCAT(DirettoreCompetizione.Nome,' ',DirettoreCompetizione.Cognome) as DirettoreCompetizione,FormulaTorneo.Formula,Impianto.NomeImpianto,Comune.Citta,Torneo.QuotaIscrizione,Torneo.PuntiVittoria,Torneo.Montepremi,Torneo.DataInizio,Torneo.DataFine,Torneo.DataChiusuraIscrizioni,Torneo.Gender,NumMaxTeamMainDraw,NumMaxTeamQualifiche,NumTeamQualificati,NumWildCard,Outdoor,RiunioneTecnica,OraInizio " +
                "FROM((((((((((Torneo LEFT JOIN TipoTorneo On Torneo.IDTipoTorneo = TipoTorneo.IDTipoTorneo)LEFT JOIN DelegatoTecnico Supervisore ON Torneo.IDSupervisore = Supervisore.IDDelegato)LEFT JOIN ArbitraTorneo On ArbitraTorneo.IDDelegato = Torneo.IDSupervisoreArbitrale)LEFT JOIN DelegatoTecnico SupervisoreArbitrale On Torneo.IDSupervisoreArbitrale = SupervisoreArbitrale.IDDelegato)LEFT JOIN DelegatoTecnico DirettoreCompetizione On Torneo.IDDirettoreCompetizione = DirettoreCompetizione.IDDelegato)LEFT JOIN FormulaTorneo ON Torneo.IDFormula = FormulaTorneo.IDFormula)LEFT JOIN ImpiantoTorneo On ImpiantoTorneo.IDTorneo = Torneo.IDTorneo)LEFT JOIN Impianto On Torneo.IDImpianto = Impianto.IDImpianto)LEFT JOIN Comune On Impianto.IDComune = Comune.IDComune)LEFT JOIN Societa On Societa.IDSocieta = Torneo.IDSocieta) " +
                "WHERE CAST(Torneo.DataFine as DATE) <= GETDATE() AND Torneo.IdSupervisore = @IDAtleta";
            comando = new SqlCommand(sql, conn);
            comando.Parameters.Add(new SqlParameter("IDAtleta", idatleta));
            risultato = new DataTable();
            adapter = new SqlDataAdapter(comando);
        ...
        public DataTable GetTorneiInCorsoDelegato(int idatleta)
        {
            SqlDataAdapter adapter;
            SqlCommand comando;
            string sql;
            ...
            sql += "SELECT DISTINCT Torneo.IDTorneo,Torneo.Titolo,Societa.NomeSocieta,TipoTorneo.Descrizione AS TipoTorneo,CONCAT(Supervisore.Nome,' ',Supervisore.Cognome) as SupervisoreTorneo,CONCAT(SupervisoreArbitrale.Nome,' ',SupervisoreArbitrale.Cognome) AS SupervisoreArbitrale,CONCAT(DirettoreCompetizione.Nome,' ',DirettoreCompetizione.Cognome) as DirettoreCompetizione,FormulaTorneo.Formula,Impianto.NomeImpianto,Comune.Citta,Torneo.QuotaIscrizione,Torneo.PuntiVittoria,Torneo.Montepremi,Torneo.DataInizio,Torneo.DataFine,Torneo.DataChiusuraIscrizioni,Torneo.Gender,NumMaxTeamMainDraw,NumMaxTeamQualifiche,NumTeamQualificati,NumWildCard,Outdoor,RiunioneTecnica,OraInizio  " +
                "FROM((((((((((Torneo LEFT JOIN TipoTorneo On Torneo.IDTipoTorneo = TipoTorneo.IDTipoTorneo)LEFT JOIN DelegatoTecnico Supervisore ON Torneo.IDSupervisore = Supervisore.IDDelegato)LEFT JOIN ArbitraTorneo On ArbitraTorneo.IDDelegato = Torneo.IDSupervisoreArbitrale)LEFT JOIN DelegatoTecnico SupervisoreArbitrale On Torneo.IDSupervisoreArbitrale = SupervisoreArbitrale.IDDelegato)LEFT JOIN DelegatoTecnico DirettoreCompetizione On Torneo.IDDirettoreCompetizione = DirettoreCompetizione.IDDelegato)LEFT JOIN FormulaTorneo ON Torneo.IDFormula = FormulaTorneo.IDFormula)LEFT JOIN ImpiantoTorneo On ImpiantoTorneo.IDTorneo = Torneo.IDTorneo)LEFT JOIN Impianto On Torneo.IDImpianto = Impianto.IDImpianto)LEFT JOIN Comune On Impianto.IDComune = Comune.IDComune)LEFT JOIN Societa On Societa.IDSocieta = Torneo.IDSocieta)  " +
                "WHERE(GETDATE() BETWEEN CAST(Torneo.DataInizio as DATE) AND CAST(Torneo.DataFine as DATE))  AND Torneo.IDSupervisore = @IDAtleta";
            comando = new SqlCommand(sql, conn);
            comando.Parameters.Add(new SqlParameter("IDAtleta", idatleta));
            risultato = new DataTable();
            adapter = new SqlDataAdapter(comando);
        ...
        public DataTable GetTorneiFinitiSocieta(int idatleta)
        {
            SqlDataAdapter adapter;
            SqlCommand comando;
            string sql;
            DataTable risultato;
            sql = "";
            sql += "SELECT DISTINCT Torneo.IDTorneo,Torneo.Titolo,Societa.NomeSocieta,TipoTorneo.Descrizione AS TipoTorneo,CONCAT(Supervisore.Nome,' ',Supervisore.Cognome) as SupervisoreTorneo,CONCAT(SupervisoreArbitrale.Nome,' ',SupervisoreArbitrale.Cognome) AS SupervisoreArbitrale,CONCAT(DirettoreCompetizione.Nome,' ',DirettoreCompetizione.Cognome) as DirettoreCompetizione,FormulaTorneo.Formula,Impianto.NomeImpianto,Comune.Citta,Torneo.QuotaIscrizione,Torneo.PuntiVittoria,Torneo.Montepremi,Torneo.DataInizio,Torneo.DataFine,Torneo.DataChiusuraIscrizioni,Torneo.Gender,NumMaxTeamMainDraw,NumMaxTeamQualifiche,NumTeamQualificati,NumWildCard,Outdoor,RiunioneTecnica,OraInizio,Autorizzato " +
                "FROM((((((((((Torneo LEFT JOIN TipoTorneo On Torneo.IDTipoTorneo = TipoTorneo.IDTipoTorneo)LEFT JOIN DelegatoTecnico Supervisore ON Torneo.IDSupervisore = Supervisore.IDDelegato)LEFT JOIN ArbitraTorneo On ArbitraTorneo.IDDelegato = Torneo.IDSupervisoreArbitrale)LEFT JOIN DelegatoTecnico SupervisoreArbitrale On Torneo.IDSupervisoreArbitrale = SupervisoreArbitrale.IDDelegato)LEFT JOIN DelegatoTecnico DirettoreCompetizione On Torneo.IDDirettoreCompetizione = DirettoreCompetizione.IDDelegato)LEFT JOIN FormulaTorneo ON Torneo.IDFormula = FormulaTorneo.IDFormula)LEFT JOIN ImpiantoTorneo On ImpiantoTorneo.IDTorneo = Torneo.IDTorneo)LEFT JOIN Impianto On Torneo.IDImpianto = Impianto.IDImpianto)LEFT JOIN Comune On Impianto.IDComune = Comune.IDComune)LEFT JOIN Societa On Societa.IDSocieta = Torneo.IDSocieta) " +
                "WHERE CAST(Torneo.DataFine as DATE) <= GETDATE() AND Torneo.IdSocieta = @IDAtleta";
            comando = new SqlCommand(sql, conn);
            comando.Parameters.Add(new SqlParameter("IDAtleta", idatleta));
            risultato = new DataTable();
            adapter = new SqlDataAdapter(comando);
        ...
        public DataTable GetTorneiInCorsoSocieta(int idatleta)
        {
            SqlDataAdapter adapter;
            SqlCommand comando;
            string sql;
            ...
            sql += "SELECT DISTINCT Torneo.IDTorneo,Torneo.Titolo,Societa.NomeSocieta,TipoTorneo.Descrizione AS TipoTorneo,CONCAT(Supervisore.Nome,' ',Supervisore.Cognome) as SupervisoreTorneo,CONCAT(SupervisoreArbitrale.Nome,' ',SupervisoreArbitrale.Cognome) AS SupervisoreArbitrale,CONCAT(DirettoreCompetizione.Nome,' ',DirettoreCompetizione.Cognome) as DirettoreCompetizione,FormulaTorneo.Formula,Impianto.NomeImpianto,Comune.Citta,Torneo.QuotaIscrizione,Torneo.PuntiVittoria,Torneo.Montepremi,Torneo.DataInizio,Torneo.DataFine,Torneo.DataChiusuraIscrizioni,Torneo.Gender,NumMaxTeamMainDraw,NumMaxTeamQualifiche,NumTeamQualificati,NumWildCard,Outdoor,RiunioneTecnica,OraInizio,Autorizzato  " +
                "FROM((((((((((Torneo LEFT JOIN TipoTorneo On Torneo.IDTipoTorneo = TipoTorneo.IDTipoTorneo)LEFT JOIN DelegatoTecnico Supervisore ON Torneo.IDSupervisore = Supervisore.IDDelegato)LEFT JOIN ArbitraTorneo On ArbitraTorneo.IDDelegato = Torneo.IDSupervisoreArbitrale)LEFT JOIN DelegatoTecnico SupervisoreArbitrale On Torneo.IDSupervisoreArbitrale = SupervisoreArbitrale.IDDelegato)LEFT JOIN DelegatoTecnico DirettoreCompetizione On Torneo.IDDirettoreCompetizione = DirettoreCompetizione.IDDelegato)LEFT JOIN FormulaTorneo ON Torneo.IDFormula = FormulaTorneo.IDFormula)LEFT JOIN ImpiantoTorneo On ImpiantoTorneo.IDTorneo = Torneo.IDTorneo)LEFT JOIN Impianto On Torneo.IDImpianto = Impianto.IDImpianto)LEFT JOIN Comune On Impianto.IDComune = Comune.IDComune)LEFT JOIN Societa On Societa.IDSocieta = Torneo.IDSocieta)  " +
                "WHERE(GETDATE() BETWEEN CAST(Torneo.DataInizio as DATE) AND CAST(Torneo.DataFine as DATE))  AND Torneo.IdSocieta = @IDAtleta";
            comando = new SqlCommand(sql, conn);
            comando.Parameters.Add(new SqlParameter("IDAtleta", idatleta));
            risultato = new DataTable();
            adapter = new SqlDataAdapter(comando);
        ...
        public string RegisterAllenatore(int idSocieta, string codTessera, string grado, string nome, string cognome, string sesso, string cF, DateTime dataNascita, string comuneNascita, string comuneResidenza, string indirizzo, string cap, string email, string tel, string pwd)
        {
            ...
            try
            {
                ...
                else return "Utente già presente nel sistema.";
            }
            catch (Exception e)
            {
                return e.Message;
        ...
        public string RegisterSocieta(string comune, string nomeSocieta, string indirizzo, string citta, string cap, DateTime dataFondazione, DateTime dataAffilizione, string codAffiliazione, bool affiliata, string email, string presidente, string referente, string sito, string tel1, string tel2, string pec, string piva, string cF, string cU, string pwd)
        {
            ...
            try
            {
                ...
                else return "Societa già presente nel sistema.";
            }
            catch (Exception e)
            {
                return e.Message;
        ...
        public string[] GetTappe(string tour)
        {
            ...
            string sql;
            sql = "";
            sql += "SELECT DISTINCT CONCAT (Impianto.Citta,' ',FORMAT( Torneo.Datainizio, 'dd/MM/yyyy', 'en-US' ))as Tappa FROM Torneo " +
                "INNER JOIN Impianto ON Torneo.IDImpianto = Impianto.IDImpianto " +
                "WHERE Torneo.Tour = @Tour AND Titolo NOT LIKE '%Qualifiche%' ORDER BY Tappa";
            comando = new SqlCommand(sql, conn);
            comando.Parameters.Add(new SqlParameter("Tour", tour));
            query = new DataTable();
            adapter = new SqlDataAdapter(comando);
        ...
        public bool UpdateTorneo(int idT,string titolo, string Tour, int puntiVittoria, double montepremi, DateTime dataChiusuraIscrizioni, DateTime dataInizio, DateTime dataFine, char genere, string formulaTorneo, int NumMaxTeamMainDraw, int NumMaxTeamQualifiche, string[] parametriTorneo, string tipoTorneo, double quotaIscrizione, int idSocieta, int numTeamQualificati, int numWildCard, int idImpianto, bool outdoor, bool riunioneTecnica, string oraInizio)
        {
            SqlDataAdapter adapter;
            SqlCommand comando;
            SqlParameter parametro;
            ...
            try
            {
                ...
                sql += "IDSocieta=@IDSocieta," +
                    ...
                    "NumTeamQualificati=@NumTeamQualificati," +
        ...
        public string RecuperaPassword(string email)
        {
            try
            {
                string from = "recoverypass.aibvc@gmail.com";
                string to = email;
                string subject = "Recupero password Account AIBVC";
                string message = "Clicca  per cambiare la password http://80.211.0.174/app/newpassword";

                SmtpClient objSmtpClient = new SmtpClient();
                objSmtpClient.Host = "smtp.gmail.com";
                objSmtpClient.Port = 587;
                objSmtpClient.EnableSsl = true;
                objSmtpClient.Credentials = new System.Net.NetworkCredential("recoverypass.aibvc@gmail.com", "dhhrkiltjljjvmih");
        ...
        public bool AggiungiImpianto(AddImpianto impianto)
        {
            SqlDataAdapter adapter;
            SqlCommand comando;
            SqlParameter parametro;
            ...
            {
                sql = "";
                sql += "Select IDComune from Comune WHERE Citta=@citta";
                comando = new SqlCommand(sql, conn);
                comando.Parameters.Add(new SqlParameter("citta", impianto.NomeComune));
                adapter = new SqlDataAdapter(comando);
                Comune = new DataTable();
                conn.Open();
                adapter.Fill(Comune);
                conn.Close();
                //Insert per aggiungere un impianto
                sql = "";
                sql += "INSERT INTO Impianto(IDComune,NomeImpianto,NumeroCampi,Indirizzo,CAP,Email,Sito,Tel,Citta) ";
                sql += "VALUES(@IDComune,@NomeImpianto,@NumeroCampi,@Indirizzo,@CAP,@Email,@Sito,@Tel,@citta)";
                comando = new SqlCommand(sql, conn);
                parametro = new SqlParameter("IDComune", Comune.Rows[0][0]);
                comando.Parameters.Add(parametro);
                parametro = new SqlParameter("NomeImpianto", impianto.NomeImpianto);
                comando.Parameters.Add(parametro);
                parametro = new SqlParameter("NumeroCampi", impianto.NumeroCampi);
                comando.Parameters.Add(parametro);
                parametro = new SqlParameter("Indirizzo", impianto.Indirizzo);
                comando.Parameters.Add(parametro);
                if (impianto.Cap != null)
                    parametro = new SqlParameter("CAP", impianto.Cap);
                else
                    parametro = new SqlParameter("CAP", DBNull.Value);
                comando.Parameters.Add(parametro);
                if (impianto.Email != null)
                    parametro = new SqlParameter("Email", impianto.Email);
                else
                    parametro = new SqlParameter("Email", DBNull.Value);
                comando.Parameters.Add(parametro);
                if (impianto.Sito != null)
                    parametro = new SqlParameter("Sito", impianto.Sito);
                else
                    parametro = new SqlParameter("Sito", DBNull.Value);
                comando.Parameters.Add(parametro);
                if (impianto.Tel != null)
                    parametro = new SqlParameter("Tel", impianto.Tel);
                else
                    parametro = new SqlParameter("Tel", DBNull.Value);
                comando.Parameters.Add(parametro);
                parametro = new SqlParameter("citta", impianto.NomeComune);
                comando.Parameters.Add(parametro);
                conn.Open();
                comando.ExecuteNonQuery();
                conn.Close();
                ...
                comando = new SqlCommand(sql, conn);
                comando.Parameters.Add(new SqlParameter("NomeImpianto", impianto.NomeImpianto));
                adapter = new SqlDataAdapter(comando);
                ...
                if (idImpianto.Rows.Count > 0)//Controllo che l'impianto sia stato trovato
                {
                    ...
                    comando = new SqlCommand(sql, conn);
                    comando.Parameters.Add(new SqlParameter("IDSocieta", impianto.IdSocieta));
        ...
        private bool CreaOttavi(int idtorneo)
        {
            try
            {
                ...
                {
                    query = "SELECT Torneo.IDTorneo,Torneo.Titolo,Squadra.NomeTeam,Pool.IDPool,Pool.PF,Pool.PS,Pool.QP FROM POOL " +
                ...
                //inserire testa di serie nella tabella
                //scorre testa di serie e set tabella
                for (int i = 0; i < TestadiSerie.Rows.Count; i++)
                {
                    numpartita++;
                    query = "INSERT INTO TestaDiSerie (IDTorneo,TitoloTorneo,NomeTeam,IDPool,PF,PS,QP) VALUES (@idtorneo,@titolo,@team,@idpool,@pf,@ps,@qp);";
                    conn.Open();
                    command = new SqlCommand(query, conn);
                    command.Parameters.Add(new SqlParameter("idtorneo", TestadiSerie.Rows[i]["IDTorneo"]));//COME GESTIRE LE DATE E L'ORARIO
                    command.Parameters.Add(new SqlParameter("titolo", TestadiSerie.Rows[i]["TitoloTorneo"]));
                    command.Parameters.Add(new SqlParameter("team", TestadiSerie.Rows[i]["NomeTeam"]));
                    command.Parameters.Add(new SqlParameter("idpool", TestadiSerie.Rows[i]["IDPool"]));
                    command.Parameters.Add(new SqlParameter("pf", TestadiSerie.Rows[i]["PF"]));
                    command.Parameters.Add(new SqlParameter("ps", TestadiSerie.Rows[i]["PS"]));
                    command.Parameters.Add(new SqlParameter("qp", TestadiSerie.Rows[i]["QP"]));
                    da = new SqlDataAdapter(command);
                    command.ExecuteNonQuery();
                    conn.Close();
                }
        ...
        public DataTable GetTestadiSerie(int idtorneo)
        {
            DataTable TestadiSerie = new DataTable();
                //prendo info da idsquadra
                string query = "SELECT * FROM TestaDiSerie WHERE IDTorneo=@idtorneo";
                conn.Open();
                SqlCommand command = new SqlCommand(query, conn);
                command.Parameters.Add(new SqlParameter("IDTorneo", idtorneo));
                SqlDataAdapter da = new SqlDataAdapter(command);
        ...
        public bool EliminaPartita(int idtorneo,int numpartita)
        {
            try
            {
                conn.Open();
                string query = "DELETE FROM Partita WHERE IDTorneo=@IDTorneo AND NumPartita=@numpartita";//scarico tour tornei
                SqlCommand command = new SqlCommand(query, conn);
                command = new SqlCommand(query, conn);
                command.Parameters.Add(new SqlParameter("IDTorneo", idtorneo));
                command.Parameters.Add(new SqlParameter("numpartita", numpartita));
                DataTable dtb = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(command);
                da.Fill(dtb);
                conn.Close();
        ...
        public bool UpdatePartita(int idTorneo, int numPartita, int idPartita, int pt1s1, int pt2s1, int pt1s2, int pt2s2, int pt1s3, int pt2s3, int numSet, int idTorneoPrincipale)
        {
            try
            {
                //se è l'ultima partita pool 1v4 2v3 elimino tutte le partite dopo -1 al set e upload result


                //calcolo punteggi per tornei poolplay
                string sql = "SELECT Formula FROM Torneo " +
                    "INNER JOIN FormulaTorneo ON Torneo.IDFormula = FormulaTorneo.IDFormula " +
                    "WHERE IDTorneo = @IDTorneo";
                SqlCommand comando = new SqlCommand(sql, conn);
                comando.Parameters.Add(new SqlParameter("IDTorneo", idTorneo));
                SqlDataAdapter adapter = new SqlDataAdapter(comando);
                DataTable puntiVittoria = new DataTable();
                conn.Open();
                adapter.Fill(puntiVittoria);
                conn.Close();
                //controllo che sia un torneo pool play
                if (puntiVittoria.Rows[0][0].ToString().Contains("Pool play"))
                {
                    //prendo numero squadre
                    conn.Open();
                    string query = "SELECT COUNT(*)FROM Partecipa WHERE IdTorneo=@IDTorneo";//scarico numero squadre
                    SqlCommand command = new SqlCommand(query, conn);
                    command.Parameters.Add(new SqlParameter("IDTorneo", idTorneo));
                    DataTable dtb = new DataTable();
                    SqlDataAdapter da = new SqlDataAdapter(command);
                    ...
                    if (dtbn.Rows.Count == 0)
                    {
                        ...
                        "WHERE IDPartita=@IDPartita AND IDTorneo=@IDTorneo";
                        comando = new SqlCommand(sql, conn);
                        SqlParameter parametro = new SqlParameter("pt1s1", pt1s1);
                        comando.Parameters.Add(parametro);
                        parametro = new SqlParameter("pt1s2", pt1s2);
                        comando.Parameters.Add(parametro);
                        parametro = new SqlParameter("pt1s3", pt1s3);
        ...
        private void EliminaPartiteSuccessive(int idtorneo,int numpartita)
        {
            conn.Open();
            string query = "DELETE FROM Partita WHERE IDTorneo=@IDTorneo AND NumPartita>@numpartita";//elimino partite successive
            SqlCommand command = new SqlCommand(query, conn);
            command = new SqlCommand(query, conn);
            command.Parameters.Add(new SqlParameter("IDTorneo", idtorneo));
            command.Parameters.Add(new SqlParameter("numpartita", numpartita));
