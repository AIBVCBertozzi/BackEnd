...
namespace API_AIBVC.Controllers
{
    ...
    public class SupervisoreController : Controller
    {
        ...
        //Return Tornei delegato Finiti
        [HttpGet("TorneiFiniti/{idsupervisore}")]
        [ProducesResponseType(400)]
        [ProducesResponseType(404)]
        [ProducesResponseType(200, Type = typeof(DataTable))]
        [Authorize(Roles = "Admin,Delegato")]
        public DataTable GetTorneiFinitiDelegato(int idsupervisore)
        {
            return db.GetTorneiFinitiDelegato(idsupervisore);
        }

        //Return Tornei atleta Finiti
        [HttpGet("TorneiInCorso/{idsupervisore}")]
        [ProducesResponseType(400)]
        [ProducesResponseType(404)]
        [ProducesResponseType(200, Type = typeof(DataTable))]
        [Authorize(Roles = "Admin,Delegato")]
        public DataTable GetTorneiInCorsoDelegato(int idsupervisore)
        {
            return db.GetTorneiInCorsoDelegato(idsupervisore);
        }

        //Return ParametriTorneo Iscritti
        [HttpGet("TorneiIscritti/{idsupervisore}")]
        [ProducesResponseType(400)]
        [ProducesResponseType(404)]
        [ProducesResponseType(200, Type = typeof(DataTable))]
        [Authorize(Roles = "Admin,Delegato")]
        public DataTable GetidTorneiIscritti(int idsupervisore)
        {
            return db.GetidTorneiIscritti(idsupervisore);
        }
    }
}
