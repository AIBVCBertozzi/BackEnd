...
namespace API_AIBVC.Controllers
{
    ...
    public class TorneoController : Controller
    {
        ...
        //Restituisce tornei di un determinato tipo
        [HttpGet("GetTorneiTipoStorico/{idTipo}")]
        [ProducesResponseType(400)]
        [ProducesResponseType(404)]
        [ProducesResponseType(500)]
        [ProducesResponseType(200, Type = typeof(DataTable))]
        public DataTable GetTorneiTipoStorico(string idTipo)
        {
            return db.GetTorneiTipoStorico(idTipo);
        }
        //get Tornei Iniziati
        ...
        [ProducesResponseType(404)]
        [ProducesResponseType(200, Type = typeof(DataTable))]
        [Authorize(Roles = "Atleta,Admin,Delegato,Atleta")]
        ...
        //elimina partita
        [HttpDelete("EliminaPartita/NumPartita/Torneo/idtorneo")]
        [ProducesResponseType(400)]
        [ProducesResponseType(404)]
        [ProducesResponseType(200, Type = typeof(DataTable))]
        [Authorize(Roles = "Delegato,Admin")]
        public ActionResult<InfoMsg> EliminaPartita(int numpartita,int idtorneo)
        {
            //ritorno risposta
            if(db.EliminaPartita(idtorneo,numpartita))
                return Ok(new InfoMsg(DateTime.Today, "Squadra Elimnata"));
            else
                return StatusCode(500, new InfoMsg(DateTime.Today, $"Impossibile eliminare la squadra"));
        }
